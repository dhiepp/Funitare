	...
	public class PawnManipulator : Manipulator
    {
        ...
        protected override void OnEndManipulation(TapGesture gesture)
        {
                ...
                gesture.StartPosition.x, gesture.StartPosition.y, raycastFilter, out hit))
            {
                ...
                {
					if (PawnController.SelectedModel == null)
					{
						ButtonController.ShowSnackBar("You must select a model first!");
						return;
					}
					// Instantiate game object at the hit pose.
					var gameObject = Instantiate(PawnController.SelectedModel, hit.Pose.position, hit.Pose.rotation);
